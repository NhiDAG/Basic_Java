        ...
        while (continueLoop) {
            ...
            switch (choices) {
                case 1:
                    int ip;
                    do {
                        System.out.println("\nChoose the type of employee to input:");
                    ...
                    do {
                        ...
                        switch (deleteN) {
                            ...
                            case 2:
                                ...
                                System.out.println("\nRemoved Successfully!");
                                deleteOfficialEmployee(rmName, oList);
                                break;
                            case 3:
                                System.out.print("Exit\n");
                                break;
...
//------------------------------------------------------------------------------
    ...
    private static ParttimeEmployee scanParttimeInfo() {
        ...
        return new ParttimeEmployee(id, fullName, age, birthday, workDay, discountRate);
    }
    ...
    private static OfficialEmployee scanOfficialInfo() {
        ...
        return new OfficialEmployee(id, fullName, age, birthday, workDay, OTtime);
    }
